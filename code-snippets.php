...
if ( ! function_exists('hlabs_snippets') ) {

// Register Custom Post Type
function hlabs_snippets() {
...
add_action( 'init', 'hlabs_snippets', 0 );

}

if ( ! function_exists( 'hlabs_code_categories' ) ) {

// Register Custom Taxonomy
function hlabs_code_categories() {
...
add_action( 'init', 'hlabs_code_categories', 0 );

}

if ( ! function_exists( 'hlabs_code_tags' ) ) {

// Register Custom Taxonomy
function hlabs_code_tags() {
...
add_action( 'init', 'hlabs_code_tags', 0 );
